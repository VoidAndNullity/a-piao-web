(function (name, factory) {
    ...
    var _w = window, _b = document.body, _d = document.documentElement; var random = function () {
        ...
        constructor: Factory, setOptions: function (options) {
            ...
            if (section) {
                ...
                var s = this._options.colorSaturation, l = this._options.colorBrightness, c = "hsla(" + section.color + ", " + s + ", " + l + ", " + section.alpha + " )"; this._context.save(); if (this._options.parallaxAmount !== 0) { this._context.translate(0, this._scroll * this._options.parallaxAmount); }
        ...
        }, _onScroll: function (e) { var screen = screenInfo(e); this._scroll = screen.scrolly; }
    }; return Factory;
});